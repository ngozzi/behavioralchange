...
def main():
    ...
    # calculate shap values and plot summary for 10 top features
    xgbmodel.fit(df[features], df['be_chg_type'])
    explainer   = shap.TreeExplainer(xgbmodel)
    shap_values = explainer.shap_values(df[features])
    shap.summary_plot(shap_values, features=df[features], max_display=10)
